...
ROLE_CONF = {
    ...
    "Arn": "arn:aws-cn:iam::012345678910:role/roleNumber"
}
...
class SchedulerTestCase(SecurityMonkeyTestCase):
    ...
    def test_find_batch_changes(self):
        ...
        ir = ItemRevision.query.join((Item, ItemRevision.id == Item.latest_revision_id)) \
            .filter(Item.arn.in_(
                ["arn:aws-cn:iam::012345678910:role/roleNumber9",
                 "arn:aws-cn:iam::012345678910:role/roleNumber10"])).all()
    ...
    def test_audit_specific_changes(self):
        ...
        for x in range(0, 3):
            ...
            role_policy["Arn"] = "arn:aws-cn:iam::012345678910:role/roleNumber{}".format(x)
