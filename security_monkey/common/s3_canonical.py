...
def get_canonical_ids(accounts, override=False):
    ...
    for account in accounts:
        ...
        @iter_account_region("s3", accounts=[account.identifier], regions=["cn-north-1"],
        ...
        def loop_over_accounts(**kwargs):
            ...
            return fetch_id(index="s3", exception_record_region="cn-north-1", account_name=account.name,
